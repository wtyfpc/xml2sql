...
-- ----------------------------
-- Table structure for gv_cmdb_model_metric_template_relation
-- ----------------------------
DROP TABLE IF EXISTS `gv_cmdb_model_metric_template_relation`;
CREATE TABLE `gv_cmdb_model_metric_template_relation`  (
...
CREATE TABLE `gv_collect_template_metric_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uni_index_template_name_metric_name`(`template_name`, `metric_name`) USING BTREE COMMENT '指标模板名称&指标名称唯一索引'
...
CREATE TABLE `gv_collection_metric`  (
  ...
  `collector` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '采集器',
  ...
  `interval` tinyint(4) NOT NULL COMMENT '采集间隔',
  ...
  `batch_group` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分组',
  `priority` tinyint(1) NOT NULL COMMENT '指标优先级',
  `collect_protocol` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '采集协议',
  `protocol_param` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '协议参数',
...
CREATE TABLE `gv_collection_metric_templ`  (
  ...
  `create_version` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模板引入版本',
  `last_modify_version` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '最后修改版本',
  PRIMARY KEY (`id`) USING BTREE,
